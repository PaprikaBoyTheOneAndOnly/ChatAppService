...
public class MessageServiceTest {
    ...
    public void getChatsFromAccount() {
        ...
        assertThat(adminsChats.get(0).getAddressableList().get(0).getTo(), is(dbMessage1.getToUser()));
        assertThat(adminsChats.get(0).getAddressableList().get(0).getFrom(), is(dbMessage1.getFromUser()));
